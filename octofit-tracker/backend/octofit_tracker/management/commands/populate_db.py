...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        app_models.Workout.objects.create(name='Morning Cardio', description='A quick morning run', duration=30)
        app_models.Workout.objects.create(name='Strength Training', description='Weight lifting session', duration=60)
